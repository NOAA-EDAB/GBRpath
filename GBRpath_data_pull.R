#Data pull for GBRpath
#User parameters----------------------------------------------------------------
if(Sys.info()['sysname']=="Windows"){
  data.dir <- "L:/EcoAP/Data/survey"
  out.dir  <- "C:/Users/Sean.Lucey/Desktop/Rpath_code/data"
  gis.dir  <- "L:/Rworkspace/GIS_files"
}

if(Sys.info()['sysname']=="Linux"){
  data.dir <- "/home/slucey/slucey/EcoAP/Data/survey"
  out.dir  <- "/home/slucey/slucey/Rpath_code/data"
...
#I am using Bigelow data 2012 to 2016 - without conversion factors
#Fall 2017 survey conducted on Pisces with no Mid coverage which will be an issue
#for future work...also spring/fall 2018 compromised due to ship issues

#B is calculated as the mean from 2013 to 2015 
...
#For now I will use simple means within strata but still running stratprep
#to get station counts
